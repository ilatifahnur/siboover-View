...
<div class="row">
    <div style="padding-left: 20px;">
        ...
        <div class="col s6">
            <div class="row">
                <form class="col s7 offset-s1" method = "post" action = {{ url('pickdriver')}} >
                    <div class="row">
                        <div>
                            <label for="date">Tanggal</label>
                            <input id="date" type="date" class="datepicker" name = "tanggal">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="input-field">
                            <textarea id="keperluan" class="materialize-textarea" name = "keperluan"></textarea>

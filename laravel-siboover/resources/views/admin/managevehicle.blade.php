...
foreach ($variable as $kendaraan) {
  ...
  echo '<div class="row">
      <div class="col s3">
          <div class="center-align">
              <a class="waves-effect waves-teal btn-flat">'.$kendaraan->nama.'</a>
          </div>
      </div>
      <div class="col s3">
          <div class="center-align">
    ...
    <form action="deletekendaraan/'.$kendaraan->nomorpolisi.'" method="post">
      ...
      <button class="btn waves-effect waves-light" type="submit" name="action">Hapus Kendaraan</button></form>
</div>
  </div>
';
}
